...
export type Server<
  T extends typeof WebSocket.WebSocket = typeof WebSocket.WebSocket,
  U extends typeof IncomingMessage = typeof IncomingMessage,
> = WebSocket.Server<T, U>;
export type RawData = WebSocket.RawData;
export type Data = WebSocket.Data;
export type CertMeta = WebSocket.CertMeta;
export type VerifyClientCallbackSync<
  Request extends IncomingMessage = IncomingMessage,
> = WebSocket.VerifyClientCallbackSync<Request>;
export type VerifyClientCallbackAsync<
  Request extends IncomingMessage = IncomingMessage,
> = WebSocket.VerifyClientCallbackAsync<Request>;
export type FinishRequestCallback = WebSocket.FinishRequestCallback;
export type ClientOptions = WebSocket.ClientOptions;
export type PerMessageDeflateOptions = WebSocket.PerMessageDeflateOptions;
export type Event = WebSocket.Event;
export type ErrorEvent = WebSocket.ErrorEvent;
export type CloseEvent = WebSocket.CloseEvent;
export type MessageEvent = WebSocket.MessageEvent;
export type WebSocketEventMap = WebSocket.WebSocketEventMap;
export type EventListenerOptions = WebSocket.EventListenerOptions;
